...
Системный промпт задаёт роль, перечисляет классы уязвимостей,
...
|---|---:|---|
| sql_validation_error         | 8  | Запрос не проходит проверку в PostgreSQL (синтаксис/объекты); не может быть выполнен |
